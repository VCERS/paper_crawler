(function () {
  ...
  window.adroll_seg_eid = "7RIKTSKLMFADZMNAGUSCSQ";
  ...
  var rule = ["064fc12d", "*10.1021/acs.nanolett*"];
...
(function(){
  ...
  if (typeof __adroll.set_pixel_cookie != 'undefined') {__adroll.set_pixel_cookie(adroll_adv_id, adroll_pix_id, "7RIKTSKLMFADZMNAGUSCSQ");}
}());
